 ...
 * @author Acer NITRO 5
 */
public class FastaForm extends javax.swing.JFrame {

    /**
     * Creates new form FastaForm
     */
    public FastaForm() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FastaForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
